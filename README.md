...
### Contenu des pages :
Effectuer la réalisation de la page d'accueil et des 4 pages contenantts chacune le menu d'un restaurant (le footer et le header sont identiques sur toutes les pages).
